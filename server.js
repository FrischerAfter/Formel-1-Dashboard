...
const YEAR = 2026;
const PORT = process.env.PORT ? parseInt(process.env.PORT, 10) : 8712;
...
const CAR_IMAGE_OVERRIDES = {
  ...
  mclaren: '/assets/cars/mclaren.png',
  redbull: '/assets/cars/redbull.png',
  alpine: '/assets/cars/alpine.png',
  racingbulls: '/assets/cars/racingbulls.png',
  haas: '/assets/cars/haas.png',
  williams: '/assets/cars/williams.png',
  audi: '/assets/cars/audi.png',
  aston: '/assets/cars/aston.png',
  cadillac: '/assets/cars/cadillac.png',
};
...
const DRIVER_PHOTO_OVERRIDES = {
  albon: '/assets/drivers/albon.png',
  alonso: '/assets/drivers/alonso.png',
  antonelli: '/assets/drivers/antonelli.png',
  bearman: '/assets/drivers/bearman.png',
  bortoleto: '/assets/drivers/bortoleto.png',
  bottas: '/assets/drivers/bottas.png',
  colapinto: '/assets/drivers/colapinto.png',
  gasly: '/assets/drivers/gasly.png',
  hadjar: '/assets/drivers/hadjar.png',
  hamilton: '/assets/drivers/hamilton.png',
  hulkenberg: '/assets/drivers/hulkenberg.png',
  lawson: '/assets/drivers/lawson.png',
  leclerc: '/assets/drivers/leclerc.png',
  lindblad: '/assets/drivers/lindblad.png',
  norris: '/assets/drivers/norris.png',
  ocon: '/assets/drivers/ocon.png',
  perez: '/assets/drivers/perez.png',
  piastri: '/assets/drivers/piastri.png',
  russell: '/assets/drivers/russell.png',
  sainz: '/assets/drivers/sainz.png',
  stroll: '/assets/drivers/stroll.png',
  verstappen: '/assets/drivers/verstappen.png',
};
...
const LOGO_OVERRIDES = {
  ...
  cadillac: '/assets/logos/cadillac.png',
...
async function main() {
  ...
  console.log('  Lade erste Daten (kurz Geduld)...');
  try {
